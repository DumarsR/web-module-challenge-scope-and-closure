 ...
 * Counter2 has a closure outside of the function while Counter1 has the closure within the function
 * 
 * 2. Which of the two uses a closure? How can you tell?
 * Counter2 is using a closure because the count is reaching outside above the function
 * 
...
function scoreboard(getInningScore, finalScore) {
  /* CODE HERE */
  console.log(`1st inning: ${/*awayTeam*/inning} - ${/*homeTeam*/inning}`)
}
